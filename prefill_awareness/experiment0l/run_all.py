"""
Experiment 0l: Comparative Rewrite — Style vs Logic vs Both
...
Run from prefill_awareness/:
    python -m experiment0l.run_all
    python -m experiment0l.run_all --from-step detection
    python -m experiment0l.run_all --from-step analysis
"""
...
from experiment0l.analysis import run_analysis
from experiment0l.config import Experiment0lConfig
from experiment0l.generate import load_tasks, run_iterative
from experiment0l.helpers import CostTracker

_STEP_ORDER = ["generate", "analysis"]


def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Experiment 0l: comparative rewrite")
