"""
Generation for Experiment 0m (Gemma 4 31B evaluator, OSS sources).

Generates responses from each source model + Gemma 4 31B self-responses (organic).
Saved: generations_dir/responses_{model_name}.json — {task_id: response_text}
"""
...
from .config import Experiment0mConfig
...
def load_responses(model_name: str, config: Experiment0mConfig) -> dict[str, str]:
