"""
Detection for Experiment 0m (single evaluator: Gemma 4 31B).

For each (source, task):

  [User merged]  [Instructions: You are a helpful assistant.]\n\n<task prompt>
  [Asst]         <source_response or Gemma's own>
...
def _run_one(
    ...
    # Gemma doesn't reliably support system role — merge into first user turn
    messages = [
