...
class Experiment0kConfig:
    ...
    # Top-N Gemini tasks from 0f by tamper_prob
    n_tasks: int = 20

    # Iterative loop settings
    max_iterations: int = 5
    convergence_threshold: int = 30   # stop if tamper_prob drops below this
    ...
    # Outputs
    output_dir: Path = Path("outputs/experiment0k")
    results_dir: Path = Path("outputs/experiment0k/results")
    figures_dir: Path = Path("outputs/experiment0k/figures")
