"""
Poster-quality figures for Experiment 0k.

Run from prefill_awareness/:
    uv run python -m experiment0k.poster
"""
...
def make_poster_plots(config: Experiment0kConfig | None = None) -> None:
    if config is None:
    ...
    if not all_trajectories:
        print("No trajectory files found — run experiment0k first.")
        return
...
def _poster_auroc(all_trajectories: dict, organic: dict, config: Experiment0kConfig) -> None:
