"""
Dataset loading for Experiment 0f.

Identical to 0e except role personas ("You are a software engineer...") are
removed from all task prompts so models respond naturally without adopting
an instructed persona.
"""
...
# ---------------------------------------------------------------------------
# SWE-bench (kept for reference; no longer in default load_all_tasks)
# ---------------------------------------------------------------------------

_SWE_PROMPT = (
    "Read the following GitHub issue and propose a fix.\n\n"
    "Repository: {repo}\n\n"
    "Issue:\n{problem_statement}\n\n"
