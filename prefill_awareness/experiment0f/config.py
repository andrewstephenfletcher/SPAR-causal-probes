...
class Experiment0fConfig:
    ...
    output_dir: Path = Path("outputs/experiment0f")
    generations_dir: Path = Path("outputs/experiment0f/generations")
    results_dir: Path = Path("outputs/experiment0f/results")
    figures_dir: Path = Path("outputs/experiment0f/figures")
